...
namespace BuildSystem {
	...
	/// </summary>
	[System.Serializable]
	public class BuildSettingsData : JsonDataBase {
	...
	public class BuildSettings : AssetBase<BuildSettings, BuildSettingsData> {
		...
		public static readonly string AssetFileDir = "Assets/Packages/BuildSystem/Conf";
		...
		/// XCode工程设定情报.
		/// </summary>
		public List<XCodeSettings> XCodeSeetings {
			get { 
				if (null != this.Data) {
					return this.Data.XCodeSeetings;
				}
				return null;
			}
		}
		...
		protected override void ApplyData(BuildSettingsData iData, bool iForceClear) {
			if (iData == null) {
				return;
			}
			...
			this.XCodeSeetings.AddRange (iData.XCodeSeetings);
