...
namespace BuildSystem
{
	public class PostProcessor
	{
		...
		public static void OnPostprocessAndroidBuild(BuildTarget target, string iBuiltProjectPath)
		{

			if (target != BuildTarget.Android) {
				return;
			}
			if(string.IsNullOrEmpty(iBuiltProjectPath) == true) {
				return;
			}

//			const string funcBlock = "PostProcessor.OnPostprocessAndroidBuild()";
//			BuildLogger.OpenBlock(funcBlock);
//
